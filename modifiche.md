...
## TABLE A
- [x] Se seleziono ad esempio lingue indoeuropee poter togliere o aggiungere lingue da quella selezione, mentre ora volendo creare un insieme ad hoc si può solo inserirle una ad una (e fare similmente per i parametri)
- [x] Modificare i filtri in modo che se seleziono una top family poi le subfamily mostrate siano solo quelle pertinenti e così via (come già nella pagina con la lista delle lingue)
