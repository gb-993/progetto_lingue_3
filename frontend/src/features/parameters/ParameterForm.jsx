...
export default function ParameterForm() {
    ...
    const [syntaxError, setSyntaxError] = useState(''); // Qui salveremo l'errore del tuo parser Python
        ...
        const fetchInitialData = async () => {
            try {
                ...
                if (isEditMode) {
                    ...
                    const { questions, ...paramData } = paramRes.data;
    ...
    // Quando l'utente digita la formula, aspettiamo 500ms e poi la mandiamo al backend
    useEffect(() => {
        const timer = setTimeout(async () => {
            if (formData.implicational_condition !== undefined) {
                try {
                    ...
                    if (res.data.valid) {
                        ...
                        // Mostriamo esattamente l'errore generato dal tuo logic_parser.py
        ...
        }, 500); // Aspetta mezzo secondo di inattività

        return () => clearTimeout(timer); // Pulisce il timer se l'utente continua a digitare
            ...
            <div className="card">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div style={{marginBottom: '1rem'}}>
                        ...
                        />
                        {/* Se il tuo parser lancia un'eccezione, il messaggio verrà stampato qui sotto in rosso */}
                    ...
                    <button type="submit" className="btn btn--primary" style={{marginTop: '1.5rem'}}>Save Parameter</button>
                    <Link to="/admin/parameters" className="btn" style={{marginTop: '1.5rem', marginLeft: '1rem'}}>Cancel</Link>
                </form>
            </div>
